...
<?xml version="1.0"?>
<rdf:RDF xmlns="http://www.FOO/DGFC#"
     xml:base="http://www.FOO/DGFC"
     ...
     xmlns:ontology="http://www.DGFC/ontology/2021/1.0#"
     xmlns:wgs84_pos="http://www.w3.org/2003/01/geo/wgs84_pos#">
    <owl:Ontology rdf:about="http://www.FOO/DGFC#">
        <owl:versionIRI rdf:resource="http://www.FOO/DGFC/1.0#"/>
    </owl:Ontology>
    ...
    <owl:ObjectProperty rdf:about="http://www.w3.org/2003/01/geo/wgs84_pos#alt">
        ...
        <rdfs:range>
            <owl:Restriction>
                <owl:onProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#hasValue"/>
 ...
 an accuracy appropriate for the size of the object and uses such as mapping .
    ...
    <owl:DatatypeProperty rdf:about="http://www.DGFC/ontology/2021/1.0#hasResult">
        <rdfs:domain rdf:resource="http://www.w3.org/ns/sosa/Observation"/>
        <rdfs:range rdf:resource="http://www.w3.org/2000/01/rdf-schema#Literal"/>
    </owl:DatatypeProperty>
    ...
    <owl:DatatypeProperty rdf:about="http://www.DGFC/ontology/2021/1.0#hasValue">
        <rdfs:domain rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <rdfs:range rdf:resource="http://www.w3.org/2000/01/rdf-schema#Literal"/>
    </owl:DatatypeProperty>
...
https://www.merriam-webster.com/dictionary/Elephantidae</rdfs:comment>
    ...
    <owl:Class rdf:about="http://purl.org/ontology/wo/Class/Reptilia">
        <rdfs:subClassOf rdf:resource="http://purl.org/ontology/wo/Class"/>
        <rdfs:comment>Reptilia is a vertebrate animal of a class that includes snakes, lizards, crocodiles, turtles, and tortoises. They are distinguished by having a dry scaly skin and typically laying soft-shelled eggs on land.</rdfs:comment>
    </owl:Class>
...
Source: https://www.merriam-webster.com/dictionary/Elephantidae</rdfs:comment>
    ...
    <owl:Class rdf:about="http://purl.org/ontology/wo/Family/Viverridae">
        <rdfs:subClassOf rdf:resource="http://purl.org/ontology/wo/Family"/>
        <rdfs:isDefinedBy>Viverridae is a family of small to medium-sized, feliform mammals. The viverrids comprise 33 species placed in 14 genera. This family was named and first described by John Edward Gray in 1821. Viverrids occur all over Africa, southern Europe, and South and Southeast Asia, across the Wallace Line</rdfs:isDefinedBy>
        <rdfs:isDefinedBy>https://en.wikipedia.org/wiki/Viverridae</rdfs:isDefinedBy>
    </owl:Class>
...
source:https://study.com/learn/lesson/animalia-kingdom-examples-characteristics-facts.html</rdfs:comment>
    ...
    <owl:Class rdf:about="http://purl.org/ontology/wo/Order/Carnivora">
        ...
        <rdfs:comment>Carnivora is a monophyletic order of placental mammals consisting of the most recent common ancestor of all cats and dogs, and all descendants of that ancestor. Members of this group are formally referred to as carnivorans, and have evolved to specialize in eating flesh.</rdfs:comment>
        <rdfs:isDefinedBy>https://en.wikipedia.org/wiki/Carnivora</rdfs:isDefinedBy>
    </owl:Class>
...
Source: google.com</rdfs:comment>
 ...
 e.g. people, places, bowling balls, as well as abstract areas like cubes.
    ...
    <owl:Class rdf:about="http://www.w3.org/ns/sosa/FeatureOfInterest">
        <owl:disjointWith rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
    ...
    <owl:Class rdf:about="http://www.w3.org/ns/sosa/ObservableProperty">
        <owl:disjointWith rdf:resource="http://www.w3.org/ns/sosa/Observation"/>
    ...
    <owl:Class rdf:about="http://www.w3.org/ns/sosa/Platform">
        <owl:disjointWith rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <rdfs:comment>A Platform is an entity that hosts other entities, particularly Sensors, Actuators, Samplers, and other Platforms.&quot;@en ;</rdfs:comment>
        <rdfs:isDefinedBy>sosa</rdfs:isDefinedBy>
        <skos:definition>&quot;A Platform is an entity that hosts other entities, particularly Sensors, Actuators, Samplers, and other Platforms.&quot;@en ;</skos:definition>
        <skos:example>&quot;A post, buoy, vehicle, ship, aircraft, satellite, cell-phone, human or animal may act as platforms for (technical or biological) sensors or actuators.&quot;@en ;</skos:example>
    </owl:Class>
    ...
    <rdf:Description rdf:about="http://www.w3.org/1999/xhtml/vocab#license"/>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Bulk_Density -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Bulk_Density">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>Measured Bulk Density of soil sample</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#CameraTrap -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#CameraTrap">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <sosa:hasFeatureOfInterest rdf:resource="http://www.DGFC/ontology/2021/1.0#image"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Name"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Path"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#localDate"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#localTime"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#make"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#model"/>
        <ontology:hasResult>Image</ontology:hasResult>
        <rdfs:comment>Wildlife cameras with embeded sensors to capture moving objects.</rdfs:comment>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Count -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Count">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Cov -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Cov">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#DGFC_ID -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#DGFC_ID">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>An identifier that is unique for GPS collar sensor observation</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#DateTime -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#DateTime">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Direction -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Direction">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Distance -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Distance">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Disturbance -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Disturbance">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>degree of logging at the site, on of &quot;Old-growth&quot;, &quot;Twic logged&quot;, Logged&quot; (when number of logging operations unknown)</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Elephantidae -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Elephantidae"/>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Elephas_maximus -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Elephas_maximus">
        ...
        <skos:definition>Asian elephant</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Elevation_masl -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Elevation_masl">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>elevation at the plot centre, in metres above sea level</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#ExtTemp -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#ExtTemp">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#First_planting_nearest_OP -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#First_planting_nearest_OP">
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#integer">2005</ontology:hasValue>
        <skos:definition>Year palm adjacent to the forest site</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Forest_type -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Forest_type">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>type of forest site, one of &quot;Continous primary&quot;, &quot;Continous logged&quot;, &quot;HCV&quot; (i.e., High Conservation Value; fragmented sites in oil palm plantations)</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#GMTDate -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#GMTDate">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>The GMT date in Sabah, Malaysia when the GPS collar collected  its readings.</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#GMTTime -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#GMTTime">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#HDOP -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#HDOP">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Horizon -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Horizon">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>Soil horizon sampled</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Horizon_Depth -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Horizon_Depth">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>Depth of the organic soil horizon sampled</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Identifier -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Identifier">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <sosa:hasFeatureOfInterest rdf:resource="http://www.DGFC/ontology/2021/1.0#image"/>
        <ontology:hasResult>DGFC_</ontology:hasResult>
        <skos:definition>Unique Soil Sample Identifier</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Land_Use -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Land_Use">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>Land use of the study plots: Unlogged tropical forest, Logged tropical forest or Oil palm plantation</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Lat -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Lat">
        <rdf:type rdf:resource="http://www.w3.org/2003/01/geo/wgs84_pos#Point"/>
        <wgs84_pos:lat rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></wgs84_pos:lat>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Long -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Long">
        <rdf:type rdf:resource="http://www.w3.org/2003/01/geo/wgs84_pos#Point"/>
        <wgs84_pos:long rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></wgs84_pos:long>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Loxodonta -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Loxodonta">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/FeatureOfInterest"/>
        <rdfs:comment>African elephant</rdfs:comment>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Mustelidae -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Mustelidae">
        <wo:family rdf:resource="http://www.DGFC/ontology/2021/1.0#Mustelidae"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Name -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Name">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>The named assigned to an image at collection time</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#PDOP -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#PDOP">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Path -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Path">
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#anyURI"></ontology:hasValue>
        <skos:definition>The URI to point at the location of the image in secure cloud</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Plot_Name -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Plot_Name">
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>Name of the 1 Ha plot sampled</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Pythonidae -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Pythonidae">
        <wo:family rdf:resource="http://www.schema.org/DGFC/python"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Replanting_nearest_OP -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Replanting_nearest_OP">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#integer">2008</ontology:hasValue>
        <skos:definition>Year of any replanting of oil palm adjacent to the forest site (fragmented sites where adjacent oil palm had undergone a second round of planting)</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Reptilia -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Reptilia">
        <wo:class rdf:resource="http://www.schema.org/DGFC/python"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Site -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Site">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/FeatureOfInterest"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>Geographical area/site which samples were taken from</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Site_code -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Site_code">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#integer">18</ontology:hasValue>
        <skos:definition>code for the study site, in the format Fa (where a can be 1-18)</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Site_name -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Site_name">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue>Sabahmas</ontology:hasValue>
        <skos:definition>name of the study site</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Site_plot_code -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Site_plot_code">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#integer">3</ontology:hasValue>
        <skos:definition>code for the study site and plot at the site, in the format FaPb (where a refers to site code, and can be 1-18; and b refers to plot code, and can be 1-3)</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Soil -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Soil">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/FeatureOfInterest"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Soil_Moisture -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Soil_Moisture">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>Gravimetric soil moisture</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Soil_Sensor -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Soil_Sensor">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <sosa:hasFeatureOfInterest rdf:resource="http://www.DGFC/ontology/2021/1.0#Soil"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Bulk_Density"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Horizon"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Horizon_Depth"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Land_Use"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Plot_Name"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Site"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Soil_Moisture"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Soil_pH"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Subplot"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#inorganic_P"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#total_C"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#total_N"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#C:N"/>
...
The data is a contribution from the BALI collaboration, which is financed by the UK&apos;s Natural Environment Research Council (NERC).</rdfs:comment>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Soil_identifier -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Soil_identifier">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Soil_pH -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Soil_pH">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>Measured pH of the soil sample</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Source_of_dates -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Source_of_dates">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>source of &quot;First_planting_nearest_OP&quot;</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Speed -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Speed">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Squamata -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Squamata">
        <wo:order rdf:resource="http://www.schema.org/DGFC/python"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Subplot -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Subplot">
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>Number of the subplot sampled within each 1 Ha plot Numeric</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Survey_date -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Survey_date">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue>12/12/2008</ontology:hasValue>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Temperature -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Temperature">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#double">21.0</ontology:hasValue>
    </owl:NamedIndividual>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#Vegetation -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Vegetation">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/FeatureOfInterest"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#Years_since_frag -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#Years_since_frag">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue>2017</ontology:hasValue>
        <skos:definition>Years since fragmentation at time of data collection. i.e., 2017 &quot;First_planting_nearest_OP&quot; (fragmented sites only)</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#image -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#image">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/FeatureOfInterest"/>
        <rdf:type rdf:resource="http://xmlns.com/foaf/0.1/Image"/>
        <sosa:isFeatureOfInterestOf rdf:resource="http://www.DGFC/ontology/2021/1.0#Identifier"/>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#inorganic_P -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#inorganic_P">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>inorganic/soluble phosphorus concentration of the soil sample</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#localDate -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#localDate">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime"></ontology:hasValue>
        <skos:definition>The current local date in Sabah, Malaysia when the image collects its readings.</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#localTime -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#localTime">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>The current local time in Sabah, Malaysia when the image collects its readings.</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#make -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#make">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>The make of the trail camera used to capture the image</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#model -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#model">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue></ontology:hasValue>
        <skos:definition>The model of the trail camera used to capture the image</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#timestamp -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#timestamp">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
    ...
    <!-- http://www.DGFC/ontology/2021/1.0#total_C -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#total_C">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>total carbon content of the soil sample</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#total_N -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#total_N">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <skos:definition>total nitrogen content of the soil sample</skos:definition>
    </owl:NamedIndividual>
    


    <!-- http://www.DGFC/ontology/2021/1.0#C:N -->


    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#C:N">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>carbon to nitrogen ratio of the soil sample</skos:definition>
    </owl:NamedIndividual>
    ...
    <owl:NamedIndividual rdf:about="http://www.DGFC/ontology/2021/1.0#C:P">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/ObservableProperty"/>
        <ontology:hasValue rdf:datatype="http://www.w3.org/2001/XMLSchema#float"></ontology:hasValue>
        <skos:definition>carbon to inorganic phosphorus ratio of the soil sample</skos:definition>
    </owl:NamedIndividual>
    ...
    <owl:NamedIndividual rdf:about="http://www.schema.org/DGFC/python">
        ...
        <rdf:type rdf:resource="http://purl.org/ontology/wo/Phylum/Chordata"/>
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/FeatureOfInterest"/>
        <wo:class rdf:resource="http://www.DGFC/ontology/2021/1.0#Reptilia"/>
        <wo:family rdf:resource="http://www.DGFC/ontology/2021/1.0#Pythonidae"/>
        <wo:order rdf:resource="http://www.DGFC/ontology/2021/1.0#Squamata"/>
    </owl:NamedIndividual>
    ...
    <owl:NamedIndividual rdf:about="http://www.schema.org/DGFC/elephant#ABAW">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <sosa:hasFeatureOfInterest rdf:resource="http://www.DGFC/ontology/2021/1.0#Elephas_maximus"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Cov"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#ExtTemp"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#HDOP"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Speed"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Temperature"/>
    </owl:NamedIndividual>
    ...
    <owl:NamedIndividual rdf:about="http://www.schema.org/DGFC/elephant#Aqeela">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <sosa:hasFeatureOfInterest rdf:resource="http://www.DGFC/ontology/2021/1.0#Elephas_maximus"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Direction"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#PDOP"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Speed"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Temperature"/>
    </owl:NamedIndividual>
    ...
    <owl:NamedIndividual rdf:about="http://www.schema.org/DGFC/elephant#Bikang1">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <sosa:hasFeatureOfInterest rdf:resource="http://www.DGFC/ontology/2021/1.0#Elephas_maximus"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Count"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Cov"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Direction"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Distance"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#GMTDate"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#GMTTime"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#HDOP"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Speed"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Temperature"/>
    </owl:NamedIndividual>
    ...
    <owl:NamedIndividual rdf:about="http://www.schema.org/DGFC/elephant#Liun">
        <rdf:type rdf:resource="http://www.w3.org/ns/sosa/Sensor"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#DateTime"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Direction"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#PDOP"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Speed"/>
        <sosa:observedProperty rdf:resource="http://www.DGFC/ontology/2021/1.0#Temperature"/>
    ...
    <owl:NamedIndividual rdf:about="http://www.w3.org/2003/01/geo/wgs84_pos#Point">
        <wgs84_pos:lat></wgs84_pos:lat>
        <wgs84_pos:long></wgs84_pos:long>
    </owl:NamedIndividual>
    ...
    <rdf:Description rdf:about="http://purl.org/dc/terms/rights">
        <terms:license>Copyright 2017 W3C/OGC.</terms:license>
    </rdf:Description>
    ...
    <rdf:Description rdf:about="http://purl.org/vocab/vann/preferredNamespaceUri">
        <terms:title>http://www.FOO.org/DGFC/</terms:title>
    </rdf:Description>
