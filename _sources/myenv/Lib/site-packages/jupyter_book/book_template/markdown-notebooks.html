...
<html lang="en" data-content_root="../../../../../" >
  ...
  <head>
    ...
    <title>Notebooks with MyST Markdown &#8212; Forest Observatory Ontology (FOO)</title>
...
<link rel="preload" as="script" href="../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8d27b9dea8ad943066ae" />
  <script src="../../../../../_static/vendor/fontawesome/6.5.1/js/all.min.js?digest=8d27b9dea8ad943066ae"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/Lib/site-packages/jupyter_book/book_template/markdown-notebooks';</script>
...
<form class="bd-search d-flex align-items-center"
  ...
  <div class="bd-header-announcement container-fluid bd-header-announcement">
    <div class="bd-header-announcement__content">Chat with FOO at https://foodatastore.zapier.app</div>
  </div>
...
<a class="navbar-brand logo" href="../../../../../intro.html">
    ...
    <img src="../../../../../_static/logo.png" class="logo__image only-light" alt="Forest Observatory Ontology (FOO) - Home"/>
    <script>document.write(`<img src="../../../../../_static/logo.png" class="logo__image only-dark" alt="Forest Observatory Ontology (FOO) - Home"/>`);</script>
 ...
 `);
    ...
    <div class="bd-toc-item navbar-nav active">
        ...
        <p aria-level="2" class="caption" role="heading"><span class="caption-text">FOO Lifecycle</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../lifecycle/development.html">FOO Development</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../lifecycle/requirements.html">FOO Requirements</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../lifecycle/implementation.html">FOO Implementation</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../lifecycle/evaluation.html">FOO Evaluation</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../lifecycle/publication.html">FOO Publication</a></li>


</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Data Sources</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../Data/collar.html">Animal GPS Collars Data</a></li>

<li class="toctree-l1"><a class="reference internal" href="../../../../../Data/soil.html">Soil Sensor Data</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../Data/veg.html">Vegetation and Habitat Data</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../Data/image.html">Camera Trap Images</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">FOO playground and Chatbot</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../playground/notebooks.html">Elephant GPS Collar Tracking</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../playground/chatbot.html">FOO Chatbot</a></li>

</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">FOO DOWNLOADS</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../linked/JSON.html">Ontology Download Formats</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Using FOO</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../software/interfaces.html">How to use FOO</a></li>
...
<div class="dropdown dropdown-launch-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://colab.research.google.com/drive/1kTW-AzkyuoNzTgCxBLeC1scC42OqKDeY?usp=sharing/github/FOO-Book/intro.html# Online location of your book/blob/docs/docs/myenv/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.md" target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../_sources/myenv/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.ipynb" target="_blank"
...
<span class="btn__text-container">.ipynb</span>
      ...
      <li><a href="../../../../../_sources/myenv/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.md" target="_blank"
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">jupyter</span><span class="o">-</span><span class="n">book</span> <span class="n">myst</span> <span class="n">init</span> <span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">markdownfile</span><span class="o">.</span><span class="n">md</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv\Lib\site-packages\jupyter_book\book_template"
        },
