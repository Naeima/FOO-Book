...
<html lang="en" data-content_root="../../../../../" >
  ...
  <head>
    ...
    <title>markdown-it-texmath &#8212; Forest Observatory Ontology (FOO)</title>
...
<link rel="preload" as="script" href="../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8d27b9dea8ad943066ae" />
  <script src="../../../../../_static/vendor/fontawesome/6.5.1/js/all.min.js?digest=8d27b9dea8ad943066ae"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/Lib/site-packages/mdit_py_plugins/texmath/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../_sources/myenv/Lib/site-packages/mdit_py_plugins/texmath/README.md" target="_blank"
...
<p>© <a class="reference external" href="https://github.com/goessner">Stefan Gössner</a></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv\Lib\site-packages\mdit_py_plugins\texmath"
        },
