...
foo: a owl:Ontology ;
    owl:versionIRI <https://w3id.org/def/foo#V2.0> ;
    ...
    dc:contributor "Omer Rana"@en ;
    dc:contributor "Benoit Goossens"@en ;
    dc:contributor "Pablo Orozco-terWengel"@en ;
    dc:contributor "Charith Perera"@en ;
...
<https://github.com/Naeima> a prov:Agent, foaf:Person ;
    foaf:name "Naeima Hamed"@en ;
    foaf:mbox <mailto:naeima.hamed@cardiff.ac.uk> ;
    foaf:affiliation "Cardiff University"@en .

<https://link.springer.com/chapter/10.1007/978-3-031-43458-7_29> a prov:Agent, foaf:Organization ;
    foaf:name "Springer, Cham"@en ;
    foaf:homepage <https://rdcu.be/dKNG2> .

### Classes ###
foo:Sensor rdf:type owl:Class ;
    owl:sameAs sosa:Sensor ;
    ...
    rdfs:definedBy <http://www.w3.org/ns/sosa/Sensor> .

foo:Observation rdf:type owl:Class ;
    owl:sameAs sosa:Observation ;
...
foo:ObservableProperty rdf:type owl:Class ;
    owl:sameAs sosa:ObservableProperty ;
...
foo:FeatureOfInterest rdf:type owl:Class ;
    owl:sameAs sosa:FeatureOfInterest ;
...
### Feature Of Interest Instances ##

foo:Soil rdf:type foo:FeatureOfInterest ;
    rdfs:label "Soil"@en ;
    ...
    dcterms:bibliographicCitation "Elias DM, McNamara NP, Ostle NJ, Majalap-Lee N, 2018. Soil properties across primary forest, logged forest, and oil palm plantation in Sabah, Malaysia. NERC Environmental Information Data Centre."@en .


foo:ElephasMaximus rdf:type foo:FeatureOfInterest ;
    rdfs:label "Asian Elephant"@en ;
    rdfs:label "Elephas maximus"@la ;
    ...
    rdfs:definedBy <https://www.iucnredlist.org/species/7140/45818198>, <https://doi.org/10.1016/j.biocon.2016.02.008> .


foo:Nasalislarvatus  rdf:type foo:FeatureOfInterest ;
    rdfs:label "Nasalis larvatus"@la ;
    rdfs:label "Proboscis Monkey"@en ;
    ...
    rdfs:definedBy  <https://doi/10.1126/sciadv.aaq0250> , <https://doi.org/10.1016/S0006-3207(99)00066-X>.


foo:ManisJavanica rdf:type foo:FeatureOfInterest ;
    rdfs:label "Manis javanica"@la ;
    rdfs:label "Sunda Pangolin"@en ;
...
foo:MalayopythonReticulatus  rdf:type   foo:FeatureOfInterest ;
    rdfs:label "Malayopython reticulatus"@la ;
    rdfs:label "Reticulated Python"@en ;
...
foo:hasFeatureOfInterest rdf:type owl:ObjectProperty ;
    owl:sameAs sosa:hasFeatureOfInterest ;
...
foo:isFeatureOfInterestOf  rdf:type owl:ObjectProperty ;
...
foo:observes rdf:type owl:ObjectProperty ;
    owl:sameAs sosa:observes ;
...
foo:madeObservation a owl:ObjectProperty ;
    owl:sameAs  sosa:madeObservation ;
...
foo:madeBySensor rdf:type owl:ObjectProperty ;
    owl:sameAs  sosa:madeBySensor  ;
...
foo:ID rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:string ;
    rdfs:label "ID" .

foo:LocalDate rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:date;
...
foo:LocalTime rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:time ;
...
foo:GMTDate rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:date ;
    rdfs:label  "GMT Date" ; 
...
foo:GMTTime rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:time ;
    rdfs:label  "GMT Time" ; 
...
foo:Latitude rdf:type owl:DatatypeProperty ;
    owl:sameAs pos:lat ;
    rdfs:domain foo:Observation ;
...
foo:Longitude rdf:type owl:DatatypeProperty ;
    owl:sameAs pos:long ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
...
foo:Temperature rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
...
foo:Speed rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "Speed" ;
...
foo:Direction rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
...
foo:Altitude rdf:type owl:DatatypeProperty ;
    owl:sameAs pos:alt ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "Altitude";
...
foo:Cov rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "Cov";
...
foo:HDOP rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "HDOP";
...
foo:Distance rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
...
foo:Count rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:integer ;
    rdfs:label "Count"@en ;
...
foo:Site rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:string ;
    rdfs:label "Site"@en ;
...
foo:LandUse rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:string ;
...
foo:PlotName rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:string ;
...
foo:Subplot rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:string ;
...
foo:Horizon rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:string ;
...
foo:SoilPH rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "Soil PH";
    skos:definition "Soil_pH Measured pH of the soil sample, numeric"@en .


foo:TotalC rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
...
foo:TotalN rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
...
foo:Silt rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "Silt"@en ;
...
foo:Clay rdf:type owl:DatatypeProperty ;
    owl:sameAs sosa:observedProperty ;
    rdfs:domain foo:Observation ;
    rdfs:range xsd:double ;
    rdfs:label "Clay"@en ;
...
### Instances ###
foo:Kuma rdf:type foo:Sensor ;
    rdfs:label "Kuma"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Jasmin rdf:type foo:Sensor ;
     rdfs:label "Jasmin"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Putut rdf:type foo:Sensor ;
    rdfs:label "Putut"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.


foo:Bikang1 rdf:type foo:Sensor ;
    rdfs:label "Bikang 1"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Bikang2 rdf:type foo:Sensor ;
    rdfs:label "Bikang 2"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Sejati rdf:type foo:Sensor ;
    rdfs:label "Sejati"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Umas2 rdf:type foo:Sensor ;
 rdfs:label "Umas2"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Ita  rdf:type foo:Sensor ;
 rdfs:label "Ita"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.


foo:Abaw  rdf:type foo:Sensor ;
rdfs:label "Abaw"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Liun rdf:type foo:Sensor ;
 rdfs:label "Liun"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Dara  rdf:type foo:Sensor ;
 rdfs:label "Dara"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Jasper  rdf:type foo:Sensor ;
  rdfs:label "Jasper"@en ;
  foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Guli rdf:type foo:Sensor ;
 rdfs:label "Guli"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Maliau  rdf:type foo:Sensor ;
 rdfs:label "Maliau"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Tunglap  rdf:type foo:Sensor ;
    rdfs:label "Tunglap"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Seri rdf:type foo:Sensor ;
  rdfs:label "Seri"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Puteri  rdf:type foo:Sensor ;
    rdfs:label "Puteri"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Tulid  rdf:type foo:Sensor ;
    rdfs:label "Tulid"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Kasih rdf:type foo:Sensor ;
    rdfs:label "Kasih"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Aqeela rdf:type foo:Sensor ;
    rdfs:label "Aqeela"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Merotai rdf:type foo:Sensor ;
    rdfs:label "Merotai"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

foo:Binbingan rdf:type foo:Sensor ;
    rdfs:label "Binbingan"@en ;
    foo:hasFeatureOfInterest foo:ElephasMaximus;
           foo:observes foo:GPSObservation.

# Observation Instance    
foo:GPSObservation  rdf:type foo:Observation ;
                      rdfs:label "GPS Observation"@en ;
                      foo:madeBySensor foo:Kuma ;     
                      foo:hasFeatureOfInterest foo:ElephasMaximus ;
                      ...
                      foo:GMTTime "23:40:35"^^xsd:time ;
                      foo:Latitude "1.237206"^^xsd:double ;
                      foo:Longitude "566.222302"^^xsd:double ;
                      foo:Temperature "24.5"^^xsd:double ;
                      foo:Speed "0.24"^^xsd:double ;
                      foo:Direction "0"^^xsd:integer ;
                      foo:Altitude "16.7"^^xsd:string ;
                      foo:Cov "0"^^xsd:double ;
                      foo:HDOP "1.64"^^xsd:double ;
                      foo:Distance "0"^^xsd:double ;
                      foo:Count "1"^^xsd:integer .

foo:GPSObservation  rdf:type foo:Observation ;
                      rdfs:label "GPS Observation"@en ;
                      foo:madeBySensor foo:Jasmin ;
                      foo:hasFeatureOfInterest foo:ElephasMaximus ;
                      foo:resultTime "2015-10-26T07:40:35"^^xsd:dateTime ;
                      foo:ID "1SAT32" ;
                      foo:LocalDate "2011-10-26"^^xsd:date ;
                      foo:LocalTime "07:40:35"^^xsd:time ;
                      foo:GMTDate "2011-10-25"^^xsd:date ;
                      foo:GMTTime "22:40:35"^^xsd:time ;
                      foo:Latitude "1.537206"^^xsd:double ;
                      foo:Longitude "565.222302"^^xsd:double ;
                      foo:Temperature "24.5"^^xsd:double ;
                      foo:Speed "0.24"^^xsd:double ;
                      foo:Direction "0"^^xsd:integer ;
                      foo:Altitude "11.7"^^xsd:string ;
                      foo:Cov "0"^^xsd:double ;
                      foo:HDOP "1.14"^^xsd:double ;
                      foo:Distance "0"^^xsd:double ;
                      foo:Count "1"^^xsd:integer .

foo:GPSObservation  rdf:type foo:Observation ;
                      rdfs:label "GPS Observation"@en ;
                      foo:madeBySensor foo:Putut ;
                      foo:hasFeatureOfInterest foo:ElephasMaximus ;
                      foo:resultTime "2011-10-26T07:40:35"^^xsd:dateTime ;
                      foo:ID "1SAT32" ;
                      foo:LocalDate "2011-10-26"^^xsd:date ;
...
foo:GPSObservation  rdf:type foo:Observation ;
                      rdfs:label "GPS Observation"@en ;
                      foo:madeBySensor foo:Binbingan ;
                      foo:hasFeatureOfInterest foo:ElephasMaximus ;
                      foo:resultTime "2011-10-26T07:40:35"^^xsd:dateTime ;
                      foo:ID "1SAT32" ;
                      foo:LocalDate "2011-10-26"^^xsd:date ;
...
foo:SoilSensor      rdf:type      foo:Sensor ;
                    rdfs:label    "Soil Sensor"@en ;
                    foo:hasFeatureOfInterest foo:Soil ;
                    foo:observes  foo:SoilObservation.

# Soil Instance
foo:SoilObservation    rdf:type foo:Observation ;
                  rdfs:label "Soil Observation"@en ;
                  foo:madeBySensor foo:SoilSensor ;
                  foo:hasFeatureOfInterest foo:Soil ;
                  foo:Identifier "MB4" ;
                  foo:Site "Maliau Basin Conservation Area"^^xsd:string ;
                  foo:LandUse "Unlogged"^^xsd:string ;
                  foo:PlotName "Belian"^^xsd:string ;
                  foo:Subplot "4"^^xsd:string ;
                  foo:Horizon "Organic"^^xsd:string ;
...
### Camera Trap Observation Instance ###

foo:ImageObservation  rdf:type foo:Observation ;
...
### lianas Instance ###
foo:lianas rdf:type foo:Sensor ;
    rdfs:label "lianas"@en ;
    foo:ID "TS1" ;
...
### lianas Instance ###
foo:lianasObservation rdf:type foo:Observation ;
